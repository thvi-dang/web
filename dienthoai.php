...
?>
    ...
    <div class="product-grid"> 
        <?php
        // Lệnh SQL chỉ lấy sản phẩm thuộc danh mục 'dien-thoai'
        $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'dien-thoai' ORDER BY id DESC");
        $stmt->execute();
        ...
        ?>
            <p style="grid-column: 1 / -1; text-align: center; color: red;">Hiện chưa có điện thoại nào.</p>
        <?php endif; ?>
    </div>
