...
?>
    ...
    <div class="product-grid"> 
        <?php
        // Lệnh SQL chỉ lấy sản phẩm thuộc danh mục 'tablet'
        $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'tablet' ORDER BY id DESC");
        $stmt->execute();
        ...
        ?>
            <p style="grid-column: 1 / -1; text-align: center; color: red;">Hiện chưa có tablet nào.</p>
        <?php endif; ?>
    </div>
